...
class myUtil {
	...
	public:
		...
		static double adjAverage(double* samples, uint8_t sample_size, uint8_t exclude_size); 
		static double adjAverage(double* samples, uint8_t sample_size) { return adjAverage(samples, sample_size, 0); } 
		static void insertToArray(double value, double* data, uint8_t size, uint8_t pos); 
